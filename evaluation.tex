...
Beyond content distribution, the length of the job descriptions is an important characteristic for evaluating LLM behavior. \autoref{fig:jd_character_comparasion} illustrates the distribution of character lengths. \\
