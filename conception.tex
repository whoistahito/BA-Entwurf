...
\begin{itemize}
    ...
    \item \textbf{Readability} — examines whether the output adheres to the defined schema, is syntactically valid, and correctly categorizes extracted items into the appropriate fields (skills, experience, or qualifications).
