...
\item[Alignment] \hfil \\``This criterion assesses how well the information in the target note aligns with that in the ground truth note'' \cite{evaluation-mertric}.Applied to this task, alignment evaluates whether the model correctly avoided extracting 'nice-to-have', 'preferred', or 'bonus' requirements.
