...
\begin{itemize}
    \item preprocessing step and LRE based on open-source LLMs, and
    \item a TSS module.
\end{itemize}

Although preprocessing the raw data is technically an essential step, it is treated as an part of the LRE pipeline in this work. Consequently, references to LRE hereafter implicitly encompass the necessary preprocessing of HTML content.
