...
\begin{description}
\item[Correctness] \hfil \\ ``This metric evaluates the accuracy of information presented in the target note. It identifies and penalizes hallucinations, misinterpretations, incorrect facts, and other inaccuracies in the target note.'' \cite{evaluation-mertric}. In the context of this thesis, this messeaure is used to evaluate whether the extracted job requirements are accurate and actually present in the input text.
