...
LLMs have demonstrated strong capabilities in transforming unstructured job descriptions into structured information. Howison et al. \cite{howison2024} demonstrated the use of LLMs to extract structured labor market data, such as education requirements and job types, from real-world job ads with statistically reliable results. Similarly, Herandi et al. \cite{herandiskilllm} proposed Skill-LLM, a fine-tuned LLM optimized for skill extraction, significantly outperforming standard Named Entity Recognition (NER) baselines in identifying hard skills.
...
graph‑based architectures, and data‑augmentation techniques.
...
accessibility and reproducibility.
    \item Industrial‑scale job matching systems require significant
