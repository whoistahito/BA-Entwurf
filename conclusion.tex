...
In this Chapter goes through research questions that were set in the \autoref{sec:research-questions}, by summerizing what has been explained in Evaluation Chapter. Then \autoref{sec:discussion} recaps the approach of building the system and reflects the results. Finally \autoref{sec:outlook} provides an outlook for future works.
