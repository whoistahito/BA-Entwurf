...
\begin{itemize}
    ...
    \item\label{itm:rq2} RQ2: How does LLM-based requirement extraction and token-embedding-driven similarity search compare to conventional job search engines with respect to the relevance and accuracy of retrieved job postings?
\end{itemize}
