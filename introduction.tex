...
\begin{itemize}
    \item\label{itm:rq1}RQ1: How effectively can open-source LLMs extract structured job requirements (skills, experience, qualifications) from unstructured job descriptions?

    \item\label{itm:rq2} RQ2: How does LLM-based requirement extraction (LRE) and token-embedding-driven similarity search (TSS) compare to conventional job search engines with respect to the relevance and accuracy of retrieved job postings?
\end{itemize}
