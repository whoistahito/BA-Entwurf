...
\begin{itemize}
    ...
    \item RQ2: How does the approach proposed in this thesis compare to conventional job search engines with respect to the relevance and accuracy of retrieved job postings?
\end{itemize}
