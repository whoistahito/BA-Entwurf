...
The extractor initializes the model and tokenizer, and wraps them with the \texttt{Generator} class from the outlines library. The generation process is constrained to strictly follow the schema defined in \autoref{lst:requirements_schema}.
\begin{center}
