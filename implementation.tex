...
This design simplifies the process of managing models; adding a new model or removing an existing one only requires adding a JSON entry. For example, \autoref{lst:llm-definition} shows how to add the Qwen3-8B model.
